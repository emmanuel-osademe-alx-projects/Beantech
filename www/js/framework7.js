    ...
    window.Framework7 = function (params) {
        ...
        ************   Modals   ************
        ...
        app.showIndicator = function () {
            ...
            app.root.append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal" style="background-color: transparent;"><span class="preloader preloader-blue">' + (app.params.material ? app.params.materialPreloaderHtml : '') + '</span></div>');
        };
